...
including deprecation replacement and support fields; the canonical registry remains
the authority. An em dash means that deprecation metadata does not apply.
