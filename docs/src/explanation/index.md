...
Time-continuous processing normally uses one time chunk per channel, and WDF save/load
currently materializes the stored tensor. See the [scalability contract](scalability-contract.md)
