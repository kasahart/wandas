...
Time-continuous processing normally uses one time chunk per channel. WDF 0.4 preserves
source chunking through its lazy save/load boundary. See the [scalability contract](scalability-contract.md)
