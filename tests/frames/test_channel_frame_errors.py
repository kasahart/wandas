...
class TestFromNumpyErrors:
    """Test error messages in ChannelFrame.from_numpy."""
    ...
    def test_invalid_data_shape_3d(self) -> None:
        ...
        with pytest.raises(ValueError) as exc_info:
            ChannelFrame.from_numpy(data, sampling_rate=16000)
    ...
    def test_valid_1d_numpy_array(self) -> None:
        """Test that 1D numpy array is accepted."""
    ...
    def test_valid_2d_numpy_array(self) -> None:
        """Test that 2D numpy array is accepted."""
