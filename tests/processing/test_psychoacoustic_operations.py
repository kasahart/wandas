...
class TestLoudnessZwtv:
    ...
    def test_stereo_signal_shape(self) -> None:
        ...
        signal_mono, signal_stereo, dask_mono, dask_stereo = _loudness_signal()
        LoudnessZwtv(_SR, field_type="free")
...
class TestRoughnessDwSpec:
    ...
    def test_operation_name(self) -> None:
        """Test that operation has correct name."""
        signal_mono, signal_stereo, dask_mono, dask_stereo = _roughness_spec_signal()
...
class TestSharpnessDin:
    ...
    def test_operation_name(self) -> None:
        """Test that operation has correct name."""
        signal_mono, signal_stereo, dask_mono, dask_stereo = _sharpness_signal()
        op = SharpnessDin(_SR)
