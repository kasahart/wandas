...
- For a new Frame, `AudioOperation`, or public Frame method, use the
  [Frame and Operation extension guide](../../docs/src/contributing/frame-operation-extensions.md)
  to classify the smallest extension and map its processing, Frame, Recipe,
  export, documentation, and test impact.
